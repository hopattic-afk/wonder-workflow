...
export const HOME_DESCRIPTION =
  "For owners of cleaning, landscaping, detailing, signs, restoration, hospitality, retail, and similar shops. Spot where work gets stuck: missed calls, missing invoices, inventory, and handoffs. Free 2-minute assessment, then a complimentary 30-minute Operations Fit Review.";
...
export const HOME_DECK =
  "Missed calls while you’re on a job. Quotes sitting. Notes that never reach the crew. Kitchen invoices in a folder. Inventory that walks off. We map one real path of work and make the next step obvious.";
...
export const WHO_FOR_BODY =
  "Cleaning, landscaping, detailing, signs and print, restoration, moving, hospitality (restaurants, bars, hotels, catering), retail, and similar shops with roughly 1–50 people. If work lives in group texts, whiteboards, and “just ask me,” you’re in the right place.";
